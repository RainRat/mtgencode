...
"""
    ...
    prime_group.add_argument("--supertypes", type=str, help="Force specific supertypes (Field 2, for example, 'legendary').")
    prime_group.add_argument("--types", type=str, help="Force specific card types (Field 3, for example, 'creature').")
    prime_group.add_argument("--loyalty", type=str, help="Force a specific loyalty or defense (Field 4).")
    prime_group.add_argument("--subtypes", type=str, help="Force specific subtypes (Field 5, for example, 'elf warrior').")
    prime_group.add_argument("--rarity", type=str, help="Force a specific rarity marker (Field 6, for example, 'O', 'A').")
    prime_group.add_argument("--powertoughness", type=str, help="Force a specific Power/Toughness (Field 7, for example, '&^^/&^^').")
    prime_group.add_argument("--manacost", type=str, help="Force a specific mana cost (Field 8, for example, '{WW}').")
