...
def handle_functional(args):
    ...
    if not args.quiet:
        print("Completed search for cards with the same mechanics.", file=sys.stderr)
    ...
    if args.json:
        ...
        if not args.quiet:
            ...
            utils.print_header("GROUPS WITH THE SAME MECHANICS", count=count_str, use_color=use_color)
